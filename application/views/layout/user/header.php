        ...
        <div class="deznav">
            <div class="deznav-scroll">
                <ul class="metismenu" id="menu">
                    ...
                    <li><a href="<?= site_url('dashboard') ?>" class="ai-icon" aria-expanded="false">
                            <i class="flaticon-381-home"></i>
                            <span class="nav-text">absen masuk</span>
                        </a>
                    </li>
                    <li><a href="<?= site_url('abson') ?>" class="ai-icon" aria-expanded="false">
                            <i class="flaticon-381-home"></i>
                            <span class="nav-text">absen pulang</span>
                        </a>
                    </li>
                    ...
                    <li><a href="<?= site_url('cuti') ?>" class="ai-icon" aria-expanded="false">
                            ...
                            <span class="nav-text">Pengajuan Cuti/izin</span>
                        </a>
                    </li>
