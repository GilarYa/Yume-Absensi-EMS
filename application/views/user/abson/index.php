<div class="content-body">
            ...
            <div class="col-xl-4 col-lg-6 col-sm-6">
                <div class="card overflow-hidden">
                    <form method="POST" action="<?php echo base_url('abson/proses_absen') ?>" enctype="multipart/form-data">
                        <div class="card-body">
                        ...
                        <!-- <a href="<?= site_url('dashboard') ?>">About us</a> -->

                        <!-- <div class="card-footer pt-0 pb-0 text-center">
                            <div class="row">
                                <div class="col-4 pt-3 pb-3 border-right">
                                    <h3 class="mb-1">0</h3><span>Follower</span>
                                </div>
                                <div class="col-4 pt-3 pb-3 border-right">
                                    <h3 class="mb-1">0</h3><span>Place Stay</span>
                                </div>
                                <div class="col-4 pt-3 pb-3">
                                    <h3 class="mb-1">0</h3><span>Reviews</span>
                                </div>
                            </div>
                        </div> -->
                </div>
