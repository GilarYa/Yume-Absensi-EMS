        ...
        <div class="modal-content">
            ...
            <form method="post" action="<?= base_url('cuti/ajukan') ?>" enctype="multipart/form-data">
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            ...
                            <select name="jenis_cuti" class="form-control" required>
                                ...
                                <?php } ?>
                                <option value="Cuti Izin">Izin</option>
                                <option value="Cuti Sakit">Cuti </option>
                            </select>
                        </div>
                        <div class="form-group col-md-6">
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" class="btn btn-sm btn-primary light"><i class="flaticon-381-calendar-7"></i>&nbsp; kirim</button>
                </div>
            </form>
        </div>
    </div>
