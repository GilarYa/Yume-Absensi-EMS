                                ...
                                <div class="tab-content">
                                    <div class="tab-pane fade show active" id="home" role="tabpanel">
                                        <div class="pt-4">
                                            <div class="form-row">
                                                ...
                                                <div class="form-group col-md-6">
                                                    <label>steam hex <small class="text-danger">*</small></label>
                                                    <input type="text" class="form-control" name="tempat_lahir" placeholder="Masukkan Steam hex">
                                                </div>
                                                <div class="form-group col-md-6">
                                                ...
                                                <div class="form-group col-md-6">
                                                    ...
                                                    <select class="form-control" name="warga_negara">
                                                        <option hidden>Silahkan pilih</option>
                                                        <option value="WNI">yumecity</option>
                                    ...
                                    <div class="tab-pane fade" id="profile">
                                        <div class="pt-4">
                                            <div class="form-row">
                                                <div class="form-group col-md-6">
                                                    <label>Nomor Pegawai EMS <small class="text-danger">*</small></label>
                                                    <input type="text" class="form-control" name="nip" placeholder="Masukkan NIP EMS">
                                                </div> 
                                                <div class="form-group col-md-6">
                                                ...
                                                <div class="form-group col-md-6">
                                                    <label>Nomor HP IC <small class="text-danger">*</small></label>
